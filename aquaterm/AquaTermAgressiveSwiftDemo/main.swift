...
private func internalMain() {
	...
	autoreleasepool() {
		...
		var attrStr = AttributedString("e-ip+1= 0")
		var range = attrStr.index(attrStr.startIndex, offsetByCharacters: 3) ..< attrStr.index(attrStr.startIndex, offsetByCharacters: 4)
		attrStr[range].fontName = "Symbol" // Greek
		range = attrStr.index(attrStr.startIndex, offsetByCharacters: 1) ..< attrStr.index(attrStr.startIndex, offsetByCharacters: 4)
		attrStr[range].superscript = 1 // exponent
		...
		attrStr[range].fontName = "Symbol"
		range = attrStr.index(attrStr.startIndex, offsetByCharacters: 1) ..< attrStr.index(attrStr.startIndex, offsetByCharacters: 2)
		attrStr[range].fontSize = 20
		// Lower symbol 25%
		attrStr[range].baselineAdjust = -0.25
		range = attrStr.index(attrStr.startIndex, offsetByCharacters: 2) ..< attrStr.index(attrStr.startIndex, offsetByCharacters: 3)
		attrStr[range].superscript = -1
		range = attrStr.index(attrStr.startIndex, offsetByCharacters: 3) ..< attrStr.index(attrStr.startIndex, offsetByCharacters: 4)
		attrStr[range].fontName = "Times-Roman"
		range = attrStr.index(attrStr.startIndex, offsetByCharacters: 4) ..< attrStr.index(attrStr.startIndex, offsetByCharacters: 6)
		attrStr[range].superscript = 1
		range = attrStr.index(attrStr.startIndex, offsetByCharacters: 5) ..< attrStr.index(attrStr.startIndex, offsetByCharacters: 6)
		attrStr[range].fontName = "Symbol"
		range = attrStr.index(attrStr.startIndex, offsetByCharacters: 6) ..< attrStr.index(attrStr.startIndex, offsetByCharacters: 7)
